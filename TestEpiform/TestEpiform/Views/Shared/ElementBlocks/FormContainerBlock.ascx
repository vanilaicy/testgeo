...
<% if (ViewBag.RenderingFormUsingDivElement) { %>
    <div data-epiforms-metadata="<%: Model.MetadataAttribute %>" class="EPiServerForms <%: validationCssClass %>" data-epiforms-type="form" id="<%: Model.Form.FormGuid %>">
    <%}  else {%>

    <form method="post" 
          data-epiforms-metadata="<%: Model.MetadataAttribute %>"
          enctype="multipart/form-data" class="EPiServerForms <%: validationCssClass %>" data-epiforms-type="form" id="<%: Model.Form.FormGuid %>">
    ...
    <div class="Form__Status">
        <div class="Form__Status__Message <%: statusDisplay %>">
